...
# ║   v9.2: ⚡ Smart remux skip  🔁 Resume  🔊 E-AC3→AAC auto-convert   ║
# ╚══════════════════════════════════════════════════════════════════════╝
...
║   ⚡ Smart remux skip  🔁 Resume  🔊 E-AC3/AC3→AAC convert  ║
╚══════════════════════════════════════════════════════════════╝{X}
  Folder  : {Y}{FOLDER}{X}
...
print(f"{G}✔ Tamizhan v9.2 loaded — all 6 menus ready.  ⚡ Smart-skip  🔁 Resume  🔊 E-AC3→AAC{X}")
main_menu()
