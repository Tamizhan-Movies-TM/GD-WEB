   ...
   const style = document.createElement('style');
    style.textContent = `
        ...
        .glow-btn {
            ...
            z-index: 1;
            border: 2px solid;
            border-radius: 8px;// Redesigned by telegram.dog/TheFirstSpeedster at https://www.npmjs.com/package/@googledrive/index which was written by someone else, credits are given on Source Page.
// v2.3.5
// Initialize the page
function init() {
	// Add Vapor theme outline button styles
