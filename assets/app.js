...
function onSearchResultItemClick(file_id, can_preview, file) {
	...
	var gdrive_btn = `<a class="btn btn-secondary d-flex align-items-center gap-2" href="/fallback?id=${file_id}${can_preview ? '&a=view' : ''}" id="file_drive_link" target="_blank">${gdrive_icon}Google Drive</a>`;
