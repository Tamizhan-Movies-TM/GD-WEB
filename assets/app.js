...
<div class="card">
  ...
  <button id="download-btn" class="btn btn-outline-pink btn-lg fw-bold d-flex align-items-center justify-content-center gap-2" style="padding: 10px 24px; font-size: 1.1rem; position: relative;">
