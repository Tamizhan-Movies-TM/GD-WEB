...
function file_code(name, encoded_name, size, bytes, poster, url, mimeType, md5Checksum, createdTime, file_id, cookie_folder_id) {
   ...
   function file_video(name, encoded_name, size, poster, url, mimeType, md5Checksum, createdTime, file_id, cookie_folder_id) {
    ...
    const download_icon = `<img src="https://i.ibb.co/yBs1P9wN/Download.png" alt="Download" style="height: 32px; width: 32px; margin-right: 5px;">`;
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <!-- Vapor-styled player buttons -->
            <div class="d-flex justify-content-center flex-wrap mt-4">
                <button type="button" class="btn btn-vapor"
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="intent:${url}#Intent;component=idm.internet.download.manager/idm.internet.download.manager.Downloader;S.title=${encoded_name};end">${download_icon} 1DM (Free)</a>
                            </div>
                        </div>
                    </div>
                </div>
