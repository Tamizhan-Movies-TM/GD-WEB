...
<div class="card" style="padding: 0 0 0.3rem 0;border-radius:.5rem;width:100%;overflow:hidden;">
  <div style="width: justify-content-center; margin-left: auto; margin-bottom: 15px;">
    <div style="height:30px; line-height:30px; padding:0 20px; border-radius:4px; background: transparent;">
