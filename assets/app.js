  ...
  <div class="card-body">
          ...
          <tbody>
            <tr>
              <th scope="row" class="w-25">
                <i class="fa-regular fa-folder-closed fa-fw me-2"></i>
                <span class="tth">Name</span>
              </th>
              <td>${name}</td>
            </tr>
    ...
    <div class="mt-4">
      ...
      <div class="d-flex flex-wrap justify-content-center gap-3 mb-4">
        <!-- VLC -->
        <button type="button" class="btn btn-outline-warning player-btn"
        ...
        <!-- MX Player -->
        <button type="button" class="btn btn-outline-info player-btn"
        ...
        <!-- XPlayer -->
        <button type="button" class="btn btn-outline-success player-btn"
        ...
        <!-- PLAYit -->
        <button type="button" class="btn btn-outline-danger player-btn"
      ...
      <div class="d-flex justify-content-center">
        <div class="btn-group">
          <a href="${url}" class="btn btn-success">
            <i class="fas fa-bolt fa-fw me-2"></i>Index Download Link
          </a>
          ...
          <div class="dropdown-menu dropdown-menu-dark">
            <a class="dropdown-item" href="intent:${url}#Intent;package=com.playit.videoplayer;category=android.intent.category.DEFAULT;type=video/*;S.title=${encoded_name};end">
              <img src="https://i.ibb.co/F4Fm9yRx/playit-icon.png" alt="Playit" class="dropdown-icon"> Playit
            </a>
            <a class="dropdown-item" href="intent:${url}#Intent;package=video.player.videoplayer;category=android.intent.category.DEFAULT;type=video/*;S.title=${encoded_name};end">
              <img src="https://i.ibb.co/x83mLGBD/xplayer-icon.png" alt="XPlayer" class="dropdown-icon"> XPlayer
            </a>
            <a class="dropdown-item" href="intent:${url}#Intent;package=com.mxtech.videoplayer.ad;category=android.intent.category.DEFAULT;type=video/*;S.title=${encoded_name};end">
              <img src="https://i.ibb.co/xqytzzbY/Mxplayer-icon.png" alt="MX Player" class="dropdown-icon"> MX Player
            </a>
            <a class="dropdown-item" href="intent:${url}#Intent;package=org.videolan.vlc;category=android.intent.category.DEFAULT;type=video/*;S.title=${encoded_name};end">
              <img src="https://i.ibb.co/8DWdwRnr/vlc.png" alt="VLC Player" class="dropdown-icon"> VLC Player
            </a>
            ...
            <a class="dropdown-item" href="intent:${url}#Intent;component=idm.internet.download.manager/idm.internet.download.manager.Downloader;S.title=${encoded_name};end">
              <img src="https://i.ibb.co/yBs1P9wN/Download.png" alt="Download" class="dropdown-icon"> 1DM (Free)
            </a>
          </div>
        </div>
      </div>
