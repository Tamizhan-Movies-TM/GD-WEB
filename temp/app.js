    ...
    <div class="col-lg-6 col-md-12">
        <div class="card text-white mb-3 h-100">
            <div class="card-header">
                <i class="fa-solid fa-hand-holding-dollar"></i> Pay &nbs;₹5
               </div>
               <div class="card-body d-flex align-items-center justify-content-center">
                <div class="text-center">
                    <p class="mb-2">Pay ₹5 and send the payment screenshot to <a href="${UI.contact_link}" title="Payment Screenshot Send To Admin Contact.">Contact Admin</a>. You'll receive a direct streaming and download link for your requested one movie ✅ (no ads, no URL shortener links)</p>
