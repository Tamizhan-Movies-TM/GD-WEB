        ...
        <div class="col-lg-6 col-md-12">
          ...
          <div class="card-body d-flex align-items-center justify-content-center">
					<div class="donate btn p-0">
						<a class="btn" href="https://trakteer.id/jovanzers/tip" title="Click me!" style="background: #3B556E;" target="_blank">
						<i class="fa-solid fa-money-check-dollar">Click Here To Payment </a>
