	...
	<div class="row g-3 mt-0">
        <div class="col-lg-6 col-md-12">
          	<div class="card text-white mb-3 h-100">
                ...
                <div class="card-body">
                    <p class="mb-3 text-center">Pay &nbsp;₹5 &nbsp;and &nbsp;Send &nbsp;The &nbsp;Payment &nbsp;Screenshot &nbsp;To <a href="${UI.contact_link}" title="Contact Admin" class="text-decoration-underline">Contact Admin</a><br>You'll Receive a Direct Link for your Requested Movies (No ads, direct links only)</p>
