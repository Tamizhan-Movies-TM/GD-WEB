...
<div class="row g-3 mt-0">
    <footer class="footer text-center mt-auto container-fluid ${UI.footer_style_class}" 
        style="${UI.fixed_footer ? 'position: fixed; bottom: 0;' : ''}
        width: 100%;
