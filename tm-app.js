...
// =============================================================================
// INLINE PROTECTION + STYLES — moved from HTML to keep view-source clean
// =============================================================================
(function () {
...
.list-group-item, .list-group-item.disabled, .list-group-item:disabled { background: transparent; }
.list-group-item-action:focus, .list-group-item-action:hover {
  background-color: rgb(216 216 216 / 20%) !important;
  backdrop-filter: blur(4px);
  -webkit-backdrop-filter: blur(4px);
  transition: background-color 0.2s ease;
}
.list-group-item-action:active { background-color: rgb(216 216 216 / 30%) !important; }
...
.dropdown-item:focus, .dropdown-item:hover { background-color: #007053; }
.donate { position: relative; width: fit-content; margin: auto; }
.donate .qrcode {
  display: none;
  position: absolute;
  z-index: 99;
...
.donate:hover .qrcode { display: block; }
.dropdown-menu, .qrcode { box-shadow: 0px 16px 48px 0px rgba(0,0,0,0.5); }
.fa, .fab, .fas, .fa-regular, .fa-solid { margin-right: 0.5rem; }
...
.hover-overlay:hover { opacity: .9; }
.overlay {
  position: absolute; width: 100%; height: 100%;
  background: rgba(0,0,0); opacity: .9;
}
table { word-break: break-word; }
.table { --bs-table-bg: unset; }
.table th { min-width: 8rem; }
.table td, .table th { border-color: rgba(140, 130, 115, 0.13); }
tr:first-child th, tr:first-child td { border-top: none; padding-top: 0; }
.video-js, .vjs-tech, div.vjs-poster > picture > img {
  border-radius: 0.375rem; height: 100%!important;
}
.video-js .vjs-control-bar {
  border-bottom-left-radius: 0.375rem;
  border-bottom-right-radius: 0.375rem;
}
.vjs-poster img { -o-object-fit: cover!important; object-fit: cover!important; }
@media (max-width: 540px) {
  .btn-block { width: 100%; }
  .table th { min-width: auto; width: 30px !important; }
  .tth { display: none; }
}
...
.footer-text { font-size: 40px; }
a { color: white; }
p { color: white; }
.logo_new { font-size: 50px; color: white; }
.loading {
  position: fixed; z-index: 999; height: 2em; width: 2em;
  overflow: show; margin: auto; top: 0; left: 0; bottom: 0; right: 0;
}
.loading:before {
...
.loading:not(:required) {
  font: 0/0 a; color: transparent; text-shadow: none;
  background-color: transparent; border: 0;
}
.loading:not(:required):after {
  content: ''; display: block; font-size: 10px; width: 1em; height: 1em;
  margin-top: -0.5em;
  ...
  border-radius: 0.5em;
  box-shadow:
    rgba(255,255,255,.75) 1.5em 0 0 0, rgba(255,255,255,.75) 1.1em 1.1em 0 0,
    rgba(255,255,255,.75) 0 1.5em 0 0, rgba(255,255,255,.75) -1.1em 1.1em 0 0,
    rgba(255,255,255,.75) -1.5em 0 0 0, rgba(255,255,255,.75) -1.1em -1.1em 0 0,
    rgba(255,255,255,.75) 0 -1.5em 0 0, rgba(255,255,255,.75) 1.1em -1.1em 0 0;
}
