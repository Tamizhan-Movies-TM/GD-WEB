        ...
        <div class="text-center">
          ...
          ${getDownloadButton(url, encoded_name, file_id, bytes)}
            ...
            <div class="dropdown-menu dropdown-menu-end">
              <h6 class="dropdown-header" style="color:#fff; padding-top:10px; padding-bottom:6px; font-size:0.75rem; letter-spacing:0.05em;"><i class="fa-brands fa-android" style="color:#3ddc84;"></i> Android Players</h6>
              ...
              <h6 class="dropdown-header" style="color:#fff; padding-top:14px; padding-bottom:6px; font-size:0.75rem; letter-spacing:0.05em;"><i class="fa-brands fa-apple" style="color:#fff;"></i> iPhone Players</h6>
