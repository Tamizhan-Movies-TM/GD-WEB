...
function generateGDFlixLink(fileId) {
    return new Promise((resolve, reject) => {
        ...
        // ✅ Call final URL directly — skips all redirects (gdflix.com→ddflix.xyz→gdflix.dev→new3.gdflix.app)
        const gdflixApiUrl = `https://new3.gdflix.app/v2/share?id=${encodeURIComponent(fileId)}&key=${encodeURIComponent(GDFLIX_API_KEY)}`;
