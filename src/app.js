...
<footer class="footer text-center mt-auto container ${UI.footer_style_class}" style="${UI.fixed_footer ? 'position: fixed; bottom: 0; left: 0; width: 100%; z-index: 1030;' : ''} ${UI.hide_footer ? 'display:none;' : 'display:block;'}">
