  ...
  <div class="card text-center">
    ...
    ${UI.disable_video_download ? `` : `
      ...
      <div class="btn-group text-center">
          ...
          <a class="dropdown-item" href="intent:${url}#Intent;package=com.mxtech.videoplayer.ad;category=android.intent.category.DEFAULT;type=video/*;S.title=${encoded_name};end">MX Player (Free)</a>
          <a class="dropdown-item" href="intent:${url}#Intent;package=com.mxtech.videoplayer.pro;category=android.intent.category.DEFAULT;type=video/*;S.title=${encoded_name};end">MX Player (Pro)</a>
  ...
  <div class="card text-center">
    ...
    ${UI.disable_audio_download ? `` : `
      ...
      <div class="btn-group text-center">
          ...
          <a class="dropdown-item" href="intent:${url}#Intent;package=com.mxtech.videoplayer.ad;category=android.intent.category.DEFAULT;type=audio/*;S.title=${encoded_name};end">MX Player (Free)</a>
          <a class="dropdown-item intent-link" href="intent:${url}#Intent;component=idm.internet.download.manager/idm.internet.download.manager.Downloader;S.title=${encoded_name};end" data-playstore="https://play.google.com/store/apps/details?id=idm.internet.download.manager">1DM (Free)</a>
          <a class="dropdown-item intent-link" href="intent:${url}#Intent;component=idm.internet.download.manager.adm.lite/idm.internet.download.manager.Downloader;S.title=${encoded_name};end" data-playstore="https://play.google.com/store/apps/details?id=idm.internet.download.manager.adm.lite">1DM (Lite)</a>
          <a class="dropdown-item intent-link" href="intent:${url}#Intent;component=idm.internet.download.manager.plus/idm.internet.download.manager.Downloader;S.title=${encoded_name};end" data-playstore="https://play.google.com/store/apps/details?id=idm.internet.download.manager.plus">1DM+ (Plus)</a>
          </div>
      </div>
      <br>
      </div>
