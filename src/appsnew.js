...
function list(path, id = '', fallback = false) {
    ...
    <div class="card">
        ...
        <div class="d-flex align-items-center gap-2 px-3 py-1" id="tm-sort-bar" style="background:#000; border-bottom:1px solid rgba(255,255,255,.1); font-size:12px; color:rgba(255,255,255,.55);">
