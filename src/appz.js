		...
		<div class="card-body row g-3">
			<div class="col-lg-4 col-md-12">${poster && !mimeType.startsWith('application/vnd.google-apps') ? `
				...
				<div class="h-100 border border-dark rounded d-flex justify-content-center align-items-center flex-column gap-3 pt-4 pb-4" style="--bs-border-opacity: .5;">
					<span><img src="https://cdn.jsdelivr.net/gh/Karthick36/Google-Drive-Index@master/images/zip-icon.png" alt="Zip Icon" style="width: 60px; height: 60px;"></span>
					<span><a href="https://telegram.me/tamizhan_updates/51" target="_blank" style="text-decoration: none;">How to Extract Zip file</a></span>
				</div>`}
			</div>
